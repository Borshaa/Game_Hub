...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 14, 2023 at 02:32 PM
...
--
-- Dumping data for table `dev_game_store`
--

INSERT INTO `dev_game_store` (`dev_id`, `Title`, `Details`, `Image`, `Link`, `Developer`, `Dev_contact`, `Dev_donation`) VALUES
(1, 'Catch The Ball', 'There will be multiple balls, the player needs to collect as much balls as possible from the selected ones. There will be a time limit. Also there will be some bomb, catching those will cause the end of the game. ', 'drive.google.com/catch_the_ball', 'www.catchtheball.com', 'Borsha Ahmed', 'borsha@gmail.com', '01010101012'),
(2, 'abcd', 'sdf', 'dxv', 'dxv', 'dfs', 'sadxc', 'ac');
...
CREATE TABLE `feedback` (
  ...
  `Name` text NOT NULL DEFAULT 'Anonymous Member',
...
INSERT INTO `feedback` (`Feedback_ID`, `Name`, `Contact`, `Feedback`, `Featured`) VALUES
(4, 'Zubair Ahmed', '06969696969', 'I am the devil. ', 1),
(5, 'Sadia Afrin', '01234567892', 'This is great!', 0);
...
INSERT INTO `order` (`order_id`, `name`, `address`, `status`, `order_total`, `number`) VALUES
(4, 'Sadia', 'Uttara, Dhaka', 'Pending', 37300, 1234567892),
(5, 'Sadia', 'abcd', 'Pending', 6700, 976);
...
INSERT INTO `orders` (`order_id`, `track_id`, `user_id`, `name`, `address`, `status`, `order_total`, `number`, `del_man_id`) VALUES
(1, '657aeef541a34', 1, 'Sadia Afrin', 'House: 7, Road: 8, Sector: 8, Uttara', 'Pending', 6700, 1533350787, 0),
(2, '657aef0f18a7b', 1, 'Sadia Afrin', 'House: 7, Road: 8, Sector: 8, Uttara', 'Pending', 6700, 1533350787, 0),
(3, '657af29733292', 2, 'Sadia Afrin', 'House: 7, Road: 8, Sector: 8, Uttara', 'Pending', 28600, 1533350787, 0);
...
(2, 'Sadia', 'sadia.afrin9@g.bracu.ac.bd', '827ccb0eea8a706c4c34a16891f84e7b');
...
(2, 0, '', 'valorant', 0x76616c6f72616e742e6d7034, '2023-12-14 12:10:54'),
(5, 0, '', 'valorant clutch moment', 0x76616c6f722e6d7034, '2023-12-14 12:12:43'),
(6, 0, '', 'games', 0x76616c6f72616e742e6d7034, '2023-12-14 12:21:25');
